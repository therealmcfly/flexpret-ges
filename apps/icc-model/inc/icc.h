...
#ifndef ICC_TIMESTEP_MS
#define ICC_TIMESTEP_MS 200U
#endif

#if ICC_TIMESTEP_MS == 0U || ICC_TIMESTEP_MS > 200U
#error "ICC_TIMESTEP_MS must be from 1 to 200 ms"
#endif

#if 200U % ICC_TIMESTEP_MS != 0U
#error "ICC_TIMESTEP_MS must divide the calibrated 200 ms base timestep"
#endif
