...
# Quartus build script for FlexPRET DE1-SoC Bootloader
package require ::quartus::project
package require ::quartus::flow

# Variables
set projectName "de1soc_bootloader"
set part "5CSEMA5F31C6"
set outputDir "."

puts "Setting up FlexPRET Bootloader for DE1-SoC in: [pwd]"
...
# Source main DE1-SoC constraints
...
puts ""
puts {Note: UART_TX/RX are mapped to GPIO_0[0:1] pins in the Top.v file.}
puts {Connect external UART adapter to GPIO_0 header pins 1 (TX) and 3 (RX).}